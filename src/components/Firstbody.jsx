...
import contest2 from '../assets/male contestant 1.jpg'
import contest3 from '../assets/contestant 2.png'

const Firstbody = () => {
    return (
       <div className="grid container1">
          <div className="g-col-6 box1">
          <h1 class="display-3 disPlay">Vote Your Favourite <br/>
                Instructors <b>Here</b></h1>

                <p class="h1 Ph1">Our design projects are fresh and simple and will <br/> 
                    benefit your business greatly. Learn more about our work!</p>

                    <button type="button" class="btn btn-warning d-btn">VOTE NOW</button>
                    <button type="button" class="btn btn-outline-secondary d-btn2">JOIN SMARTVOTE</button>
...
<div className="row d-row">
              <div className="col-6 col-md-4 dcol6">
                <img src={contest1} alt="..." className="rounded-circle d-image" />
              </div>
              <div className="col-6 col-md-4 d-col6">
                <p className="card-text d-text"><b>Peter Akaliro</b> <br/> Web development</p>
              </div>
...
<div className="row d-row2">
              <div className="col-6 col-md-4 dcol6">
                <img src={contest2} className="rounded-circle d-image" alt="..." />
              </div>
              <div className="col-6 col-md-4 d-col6">
                <p className="card-text d-text"><b>Charles Clifford</b> <br /> UI/UX Designer</p>
              </div>
              <div className="col-6 col-md-4">
